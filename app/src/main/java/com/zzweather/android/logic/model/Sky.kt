package com.zzweather.android.logic.model
...
private val sky = mapOf(
    ...
    "PARTLY_DAY" to Sky("多云",R.drawable.ic_partly_cloud_day,
                R.drawable.bg_partly_cloudy_day),
    "PARTLY_NIGHT" to Sky("多云",R.drawable.ic_partly_cloud_night,
    ...
    "DUST" to Sky("浮沉",R.drawable.ic_fog,R.drawable.search_bg)
    )
